...
def make_bar(slider_input, title):
    ...
    fig.update_layout(
        title_text=title,
        title_x=0.5,
        margin=dict(b=25, t=75, l=75, r=25),
        height=325,
        paper_bgcolor=COLORS["background"],
        xaxis_title="Allocation (by %)",
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.H2("Total 100%", style={"text-align": "right", "margin-top": "10px"}),
                            ],
                            style={"background": "whitesmoke", "padding": "10px", "border-radius": "5px"},
                        ),
